...
interface TeamMember {
  ...
  const teamMembers: TeamMember[] = [
    {
      name: "Abdulmunim Jundurahman",
      role: "Backend Engineer",
      description: "Abdulmunim is a backend engineer specializing in Django and NestJs. He is also a Machine Learning and Backend Engineer with NLP Specialization.",
      socialMedia: ["#1", "#2", "#3", "#4"],
    },
    {
      name: "Meti Lemessa",
      role: "Front-End Developer",
      description: "Meti is a senior front-end developer with experience in React and VueJs. She is also a full-stack developer with experience in NestJS and Python. She is especially good at designing and implementing user interfaces.",
      socialMedia: ["#1", "#2", "#3", "#4"],
    },
    {
      name: "Salman Ali",
      role: "Backend Engineer",
      description: "Salman drives the strategical and technical direction of the team. He is also a full-stack developer with experience in NestJS and Python. In addition to web, is especially interested in Embedded Systems..",
      socialMedia: ["#1", "#2", "#3", "#4"],
    },
    {
        name: "Sifan Fita",
        role: "Front-End Developer",
        description: "Sifan is a senior front-end developer with experience in React and VueJs. She is also a full-stack developer with experience in NestJS and Python. She is especially good at designing and implementing user interfaces.",
        socialMedia: ["#1", "#2", "#3", "#4"],
      },
